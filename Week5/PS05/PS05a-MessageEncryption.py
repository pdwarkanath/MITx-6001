...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(x)):
        	lowerdict[x[i]] = x[(i+shift)%26]
        for i in range(len(y)):
        	upperdict[y[i]] = y[(i+shift)%26]
        shift_dict = {**lowerdict,**upperdict}
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            ...
            if count > max_valid_words:
                ...
                max_valid_words_index = i
        return (26 - max_valid_words_index, self.apply_shift(26-max_valid_words_index))
